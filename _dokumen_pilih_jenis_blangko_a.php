...
?>
<form id="pilih_blangko" name="pilih_blangko" action="_dokumen_view"> 
...
<center>
	 <h2>DOKUMEN YANG DIGUNAKAN</h2>
		<select name="template_id" id="template_id" style="width:50%"  size="20" ondblclick="pilih_blangko_kirim()" autofocus required>
...
<input type="submit" name="" value="OK" class="btn btn-warning" onclick="cetak_dokumen_ku()"> 
...
function pilih_blangko_kirim()
{
  document.pilih_blangko.submit();
}
</script>
